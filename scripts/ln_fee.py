...
def main():
    ...
    parser.add_argument('--counts', nargs='+', default=[10, 10, 10])
    parser.add_argument('--amounts', nargs='+', default=[10000, 50000, 100000])
    parser.add_argument('--epsilons', nargs='+', default=[.6, .6, .6])
